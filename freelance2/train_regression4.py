...
model1_regularized = LinearRegression(learning_rate=0.01, batch_size=32, regularization=1.0, max_epochs=100, patience=3)
model1_regularized.fit(X_train[:, [0]], X_train[:, [1]])

# Save model parameters
model1_regularized.save("model4_params.npz")
